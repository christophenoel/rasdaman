...
public class InvalidSubsettingException extends WCPSProcessingError {
     ...
     */
    public InvalidSubsettingException(String axisName, Subset<String> subset) {
     ...
     * interval, time error,..)
     */
    public InvalidSubsettingException(String axisName, Subset<String> subset, String exceptionMessage) {
        super(subset.isTrimming() ? exceptionMessage.replace("$subsetDomainType", "subsetting").replace("$subsetBound", subset.getLowerLimit() + ":" + subset.getUpperLimit()).replace("$axis", axisName)
                : exceptionMessage.replace("$subsetDomainType", "slicing").replace("$subsetBound", subset.getLowerLimit()).replace("$axis", axisName));
    }
