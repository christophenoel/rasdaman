...
public class OutOfBoundsSubsettingException extends InvalidSubsettingException {
     ...
     */
    public OutOfBoundsSubsettingException(String axisName, Subset<String> subset, Double domMin, Double domMax) {
     ...
     * @param domMax upper limit of coverage's axis domain
     */
    public OutOfBoundsSubsettingException(String axisName, Subset<String> subset, String domMin, String domMax) {
