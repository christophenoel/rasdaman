 ...
 */
public class WcpsRasqlExecutor implements WcpsExecutor {

    public WcpsRasqlExecutor(WCPSResult wcpsResult)
    {
    ...
    public byte[] execute(WCPSResult wcpsResult) throws WCSException{
        ...
        RasQueryResult res = null;
           try {
               res = new RasQueryResult(RasUtil.executeRasqlQuery(wcpsResult.getResult()));
